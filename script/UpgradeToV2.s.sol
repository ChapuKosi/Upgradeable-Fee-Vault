...
contract UpgradeToV2 is Script {
    function run() external returns (address newImplementation) {
        ...
        require(keccak256(bytes(currentVersion)) == keccak256(bytes("1.0.0")), "Not V1");
        ...
        bytes memory initV2Data = abi.encodeCall(FeeVaultV2.initializeV2, (maxWithdrawPerTx, withdrawalDelay));
